...
public abstract class AbstractDealDamageHandler extends AbstractMaplePacketHandler {
    ...
    protected synchronized void applyAttack(AttackInfo attack, final MapleCharacter player, int attackCount) {
        ...
        if (attackCount != attack.numDamage && attack.skill != ChiefBandit.MESO_EXPLOSION && attack.skill != NightWalker.VAMPIRE && attack.skill != WindArcher.WIND_SHOT && attack.skill != Aran.COMBO_PENRIL) {
            return;
        }
